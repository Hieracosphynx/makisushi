$(document).ready(function(){
    ...
    function showmenu(){
        ...
        $(".category").on("click",function(){
            ...
            $(".tr-js").toggleClass("tr-js-toggle");

        });

        $(".category1").on("click",function(){
            
            $(".tr-js1").toggleClass("tr-js-toggle");

        });

        $(".category2").on("click",function(){
            
            $(".tr-js2").toggleClass("tr-js-toggle");

        });

        $(".category3").on("click",function(){
            
            $(".tr-js3").toggleClass("tr-js-toggle");

        });

        $(".category4").on("click",function(){
            
            $(".tr-js4").toggleClass("tr-js-toggle");

        });

        $(".category5").on("click",function(){
            
            $(".tr-js5").toggleClass("tr-js-toggle");

        });

        $(".category6").on("click",function(){
            
            $(".tr-js6").toggleClass("tr-js-toggle");

        });

        $(".category7").on("click",function(){
            
            $(".tr-js7").toggleClass("tr-js-toggle");

        });

        $(".category8").on("click",function(){
            
            $(".tr-js8").toggleClass("tr-js-toggle");

        });

        $(".category9").on("click",function(){
            
            $(".tr-js9").toggleClass("tr-js-toggle");

        });

        $(".category10").on("click",function(){
            
            $(".tr-js10").toggleClass("tr-js-toggle");

        });

        $(".category11").on("click",function(){
            
            $(".tr-js11").toggleClass("tr-js-toggle");

        });

        $(".category12").on("click",function(){
            
            $(".tr-js12").toggleClass("tr-js-toggle");
