    ...
    <div class="container-fluid main-container">
        ...
        <div class="container col-sm-12 parent-second">
            <div class="col-sm-10 offset-sm-1 second-container">
                ...
                <label class="create">About <span>Makisushi</span></label>
                <label class="col-lg-6 col-md-8 col-sm-12 about1">Makisushi is a Japanese Restaurant that has a unique vibe and an aesthetic ambience inside. Makisushi embraces everyone and shares the love for Japanese food to the community. 
                </label>
                
                <label class="col-lg-6 col-md-8 col-sm-12 how">How it started</label>
                
                <label class="col-lg-6 col-md-8 col-sm-12 about1">
                Makisushi Started a humble beginning on the year 2007. Before it has only 6-7 tables and can only accomodate 12-15 customers, and only has 5 staffs, the menu was also small. A tough start like any other business, throughout the years, Makisushi began to add another floor which can now accomodate 30 max people! Serving the customers with a smile.
                </label>
                
                <label class="col-lg-6 col-md-8 col-sm-12 how">Words to live by</label>
                
                <label class="col-lg-6 col-md-8 col-sm-12 about1 about2">
